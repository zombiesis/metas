...
export async function handlePublicForm(kind: 'admissions' | 'contact' | 'recruiter' | 'alumni' | 'career' | 'newsletter', request: NextRequest) {
  ...
  const leadCommon = { sourcePage, utmSource, consent: Boolean(data.consent) };
